class Card {
  ...
  _createElement() {
    const cardNewTemlate = document.querySelector(this._templateSelector).content.querySelector('.card');
    this._cardElement = cardNewTemlate.cloneNode(true);
  ...
  _handleOpenImage() {
    ...
    overlayImageName.textContent = this._name;
    overlayImageItem.src = this._link;
    overlayImageItem.alt = this._name;
  };
